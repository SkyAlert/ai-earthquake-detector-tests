...
class RealTimeMonitor:
    ...
    def __init__(self, model_path, host='localhost', port=18000, sampling_rate=100):
        self.model_path = model_path
        self.host = host
        self.port = port
...
def main():
    ...
    parser.add_argument('--port', type=int, default=18000, help='Puerto de AnyShake Observer')
